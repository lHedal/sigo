...
<div class="checkbox">
    <label>
      <input type="checkbox" name="view_reports" <?php if($user->view_reports){ echo "checked";}?>> 
    </label>
  </div>
    </div>
  </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="view_users" <?php if($user->view_users){ echo "checked";}?>> 
    </label>
  </div>
    </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="edit_users" <?php if($user->edit_users){ echo "checked";}?>> 
    </label>
  </div>
    </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="view_pacients" <?php if($user->view_pacients){ echo "checked";}?>> 
    </label>
  </div>
    </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="edit_pacients" <?php if($user->edit_pacients){ echo "checked";}?>> 
    </label>
  </div>
    </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="view_medics" <?php if($user->view_medics){ echo "checked";}?>> 
    </label>
  </div>
    </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="edit_medics" <?php if($user->edit_medics){ echo "checked";}?>> 
    </label>
  </div>
    </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="view_reservations" <?php if($user->view_reservations){ echo "checked";}?>> 
    </label>
  </div>
    </div>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="edit_reservations" <?php if($user->edit_reservations){ echo "checked";}?>> 
    </label>
  </div>
    </div>
